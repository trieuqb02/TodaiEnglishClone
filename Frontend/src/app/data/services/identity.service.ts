...
import {ApiModel} from "../models/api.interface";
...
export class IdentityService {
  ...
  register(data: RegisterModel): Observable<ApiModel<RegisterModel>> {
    return this.http.post<ApiModel<RegisterModel>>(`${baseUrl}/identity/register`, data);
  }
